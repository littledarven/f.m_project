...
//            $old_line = implode(',',$new_firm);
        ...
        public function delete_Register($new_firm){
            ...
            $content = file_get_contents('hist_firm.txt');//CATA TD DO TXT
            $new_content = str_replace($line,$new_line,$content);//SUBSTITUI A STRING PASSADA PELA EM BRANCO
            $file = fopen('hist_firm.txt','w');//W PARA ABRIR O TXT EM BRANCO
